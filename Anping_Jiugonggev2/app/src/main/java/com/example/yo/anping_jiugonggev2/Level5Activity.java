...
public class Level5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton floatingActionButton = (FloatingActionButton) findViewById(R.id.fab5);
        ...
        Button button = (Button) findViewById(R.id.solvebt5);
        sharedPreferences = getSharedPreferences("Level5Preferences",MODE_PRIVATE);
        isPreferencesSolve = sharedPreferences.getBoolean("PreferencesSolve",false);
        if(isPreferencesSolve){
            textView = (TextView) findViewById(R.id.level_tv5);
            textView.setText("安平古堡古井");
        }
    ...
    private boolean getUserLocation() {
        ...
        if(gps.canGetLocation){
            //關卡經緯度
            double level_5_latitude = 23.0020858;
            double level_5_longitude = 120.1609149;
            // 使用者經緯度
            double user_latitude = gps.getLatitude();
            double user_longitude = gps.getLongitude();
            //兩者距離
            double distance = getDistance(level_5_latitude,level_5_longitude,user_latitude,user_longitude);
            //double distance = getDistance(user_latitude,user_longitude,user_latitude,user_longitude);
